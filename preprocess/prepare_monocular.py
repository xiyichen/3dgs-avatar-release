...
parser = argparse.ArgumentParser(
    description='Preprocessing for Custom Data, with HMR results from PARE.'
)
parser.add_argument('--data-dir', type=str, help='Directory that contains raw custom data.')
